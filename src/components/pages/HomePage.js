    ...
    return (
            <section className='absolute z-0 md:h-screen md:w-screen h-max w-max inset-0 flex-wrap md:flex'>
                <div className="pt-36 pb-20 md:pt-56 md:pb-36 md:w-1/2 flex-wrap">
                    ...
                    <h1  className="animationOpacity text-4xl md:text-7xl text-gray-600 font-body flex ml-10">I AM MICHAL</h1>
                    <h1  className="animationOpacity text-4xl md:text-7xl text-gray-600 font-body flex ml-10 ">WARAKOMSKI</h1>
                </div>   
